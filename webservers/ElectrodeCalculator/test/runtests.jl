...
# !!! Main.UserApp is configured as an alias for Main.ElectrodeCalculator and you might encounter it in some tests
using Main.ElectrodeCalculator, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ElectrodeCalculator tests" begin
  @includetests ARGS
end
