...
class SequenceState():
    ...
    """
    def __init__(self, amplitude=0, phase=0, frequency = 1E6, transition = None, time = 0, triggers = 0, syncpoints = [], digital_out = [False]*N_DIGITAL):
        """
        Args:
...
class Timestamp(RFBlock):
    ...
    def __init__(self, duration, amplitude = None, phase = None, frequency= None, wait_for_trigger= False, digital_out = {}, absolute_phase=False):
        """
        Args:
...
class PhaseRamp(RFBlock):
    ...
    Linearly ramps the amplitude of the RF tone while maintaining constant frequency and phase.
    """
    def __init__(self, duration, amplitude = None, start_phase = None, end_phase = None, frequency = None, steps = 20):
        """
        Args:
            duration (float): The duration of the ramp in seconds.
...
def compile_sequence(sequence, output_json = True):
    """
