...
class SynthesizerServer(LabradServer):
    ...
    @staticmethod
    def compile_timestamp(channel, address, timestamp, phase_update, phase, amplitude, frequency, wait_for_trigger=False):
        """
    ...
    def _write_timestamps(self, timestamps, channel):
        ...
        for i, s in enumerate(timestamps):
            ...
            buffers += SynthesizerServer.compile_timestamp(channel, address, timestamp, phase_update, phase, amplitude, frequency, wait_for_trigger)
